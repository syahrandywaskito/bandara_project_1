<div class="inline-flex rounded-md shadow-lg ml-0 w-fit" role="group">
  ...
  <button
    type="reset"
    class="inline-flex items-center px-4 py-2 text-sm font-medium bg-indigo-800 text-white rounded-r-lg hover:bg-indigo-500 focus:z-10 focus:ring-2 focus:ring-indigo-800 dark:bg-slate-600 dark:hover:bg-slate-400 dark:focus:ring-slate-600"
    title="reset form"
    >
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 md:mr-3 h-5">
      <path
