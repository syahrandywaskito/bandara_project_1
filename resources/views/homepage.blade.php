...
<html lang="id" class="scroll-smooth">
  ...
  <body class="bg-gradient-to-t from-blue-300">
    {{-- navbar --}}
    <nav class="bg-gradient-to-r from-indigo-600 to-blue-300 shadow-lg rounded-lg mx-5 lg:mx-10 mt-7" id="navbar">
      <section class="mx-auto px-4 max-w-6xl">
        <section class="flex justify-between">
          ...
          <section class="flex space-x-14 lg:space-x-8">
            ...
            <section>
              <a href="{{route('homepage')}}" class="flex items-center py-4 px-2">
                ...
                <span class="font-semibold text-gray-100 text-xs sm:text-base xl:text-lg uppercase">
                  Teknik dan <br />
                  pelayanan jasa
                </span>
              </a>
            ...
            <section class="hidden md:flex items-center space-x-4 lg:space-x-2">
              <a href="{{route('homepage')}}" class="py-4 px-2 flex text-gray-100 border-b-2 border-gray-100 font-semibold">
              ...
              <a
                ...
                class="text-gray-100 hover:-translate-y-1 font-semibold rounded-lg text-sm pl-3 lg:px-5 py-2.5 text-center inline-flex items-center transition duration-200 cursor-pointer"
                type="button"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 xl:hidden h-5">
                  <path
              ...
              <a href="" class="flex py-4 px-2 text-gray-100 font-semibold hover:-translate-y-1 transition duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 xl:hidden h-5">
              ...
              <a href="{{route('kontak.user.index')}}" class="flex py-4 px-2 text-gray-100 font-semibold hover:-translate-y-1 transition duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 xl:hidden h-5">
                  <path
                    fill-rule="evenodd"
          ...
          <section class="hidden md:flex items-center space-x-3">
            <a href="{{route('login')}}" class="hidden xl:block items-center py-4 px-2 text-gray-100 font-medium hover:-translate-y-1 transition duration-200">
              <span class="hidden xl:block">
                Login
              </span>
            </a>
        ...
        <section class="hidden pb-3" id="mobile-menu">
          <ul class="text-sm">
            ...
            <li>
              <a href="" class="block text-md text-gray-100 py-4 px-2 hover:translate-x-1 transition duration-200">Layanan</a>
            </li>
            <li>
              <a href="{{route('kontak.user.index')}}" class="block text-md text-gray-100 py-4 px-2 hover:translate-x-1 transition duration-200">Hubungi Kami</a>
            </li>
            <li>
                  ...
                  <caption class="pt-2 text-right">
                    <div class="pb-6 flex justify-between items-center">
                      <div class="text-sm md:text-base">
                        <h2 class="font-montserrat font-semibold uppercase inline-flex items-center cursor-default" title="Jam Penerbangan Bisa Sewaktu-waku Berubah">
                          Jadwal keberangkatan
