      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{route('dashboard')}}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-xl font-roboto font-semibold sm:text-2xl text-gray-100 whitespace-nowrap">Dashboard Teknik</span>
          </a>
        </div>
    ...
    <section class="bg-white">
      <div class="py-10 px-4 mx-auto max-w-screen-xl lg:pt-16 lg:pb-0">
          <div class="bg-gray-50 border border-gray-100 rounded-lg shadow-lg p-8 md:p-12 mb-8">
              <h1 class="text-gray-900 text-3xl md:text-4xl font-roboto font-bold mb-4">
      ...
      <div class="px-4 mx-auto max-w-screen-xl">
            <div class="bg-gray-50 border border-gray-100 rounded-lg shadow-lg p-8 md:p-12">
                <h2 class="text-gray-900 text-3xl font-roboto font-bold mb-2">
                ...
                <h3 class="text-lg font-normal text-gray-500 mb-4"><strong>Input data baru</strong></h3>
                <ol class="text-lg font-normal text-gray-500 mb-4 list-decimal ml-4">
                ...
                <h3 class="text-lg font-normal text-gray-500 mb-4"><strong>Edit data yang sudah ada</strong></h3>
                <ol class="text-lg font-normal text-gray-500 mb-4 list-decimal ml-4">
                  <li>Tekan tombol Edit sesuai dengan data yang ingin diedit</li>
                  <li>Ganti data yang sudah ada dengan data yang baru</li>
                  <li>Setelah selesai, tekan tombol Submit</li>
                </ol>
                <h3 class="text-lg font-normal text-gray-500 mb-4"><strong>Hapus data</strong></h3>
                <ol class="text-lg font-normal text-gray-500 mb-4 list-decimal ml-4">
