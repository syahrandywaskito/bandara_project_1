                ...
                <div>
                  <form action="{{route('users.index')}}" method="GET">
                    <div class="flex">
                        ...
                        <select id="kolom" class="block p-3.5 w-full z-20 text-gray-900 bg-gray-200 border-2 border-gray-200 rounded-l-lg outline-none  focus:border-indigo-800 dark:border-gray-50 dark:bg-gray-50 font-roboto text-xs md:text-sm" name="kolom">
                        ...
                        <div class="relative w-full font-montserrat">
                            <input type="text" name="cari" class="block p-3.5 w-full z-20 text-gray-900 bg-gray-200 border-2 border-gray-200 rounded-r-lg outline-none  focus:border-indigo-800 dark:border-gray-50 dark:bg-gray-50 font-roboto text-xs md:text-sm" placeholder="Cari" required>
                        ...
                        <td class="px-6 py-4">
                          <form onsubmit="return confirm('Anda ingin mengahapus user ini ?')" action="{{route('users.destroy', $user->id)}}">
                            ...
                            <div class="inline-flex rounded-md shadow-md" role="group">
                              <button type="button" class=" inline-flex items-center px-4 py-2 text-xs md:text-sm font-medium text-gray-50 bg-indigo-800 rounded-l-lg hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 dark:bg-gray-100 dark:text-indigo-800 dark:hover:bg-indigo-900 dark:hover:text-gray-100 transition duration-200">
