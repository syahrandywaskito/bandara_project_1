        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <a href="{{route('cctv.create')}}" class="flex ml-2 md:mr-24">
              ...
              <span class="self-center font-roboto uppercase font-semibold hidden sm:block sm:text-base md:text-lg lg:text-xl text-gray-100 whitespace-nowrap">Jadwal - Ubah Data</span>
            </a>
          </div>
