      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{route('cctv.index')}}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-lg uppercase font-roboto font-semibold sm:text-xl text-gray-100 whitespace-nowrap">Perangkat - FIDS</span>
          </a>
        </div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                  ...
                  <li aria-current="page">
                    <div class="flex items-center">
                      ...
                      <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2">List FIDS</span>
                    </div>
                  </li>
                </ol>
              </nav>
