              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                ...
                <li aria-current="page">
                  <div class="flex items-center">
                    ...
                    <span class="ml-1 text-xs md:text-sm font-medium md:ml-2 dark:hover:text-slate-400">List FIDS</span>
                  </div>
                </li>
              </ol>
            </nav>
                  ...
                  <td class="px-6 py-4">
                    <form onsubmit="return confirm('Apakah anda ingin menghapus data ini ?')" action="{{route('list.fids.destroy', $data->id)}}" method="post">
                      ...
                      <div class="inline-flex rounded-md shadow-md" role="group">
                        ...
                        @include('components.dashboard.buttons._edit-in-table', ['route' => route('list.fids.edit', $data->id)])
