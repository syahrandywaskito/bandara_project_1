      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{route('cctv.index')}}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center uppercase font-roboto font-semibold hidden sm:block sm:text-base md:text-lg lg:text-xl text-gray-100 whitespace-nowrap">Perangkat - FIDS</span>
          </a>
        </div>
      ...
      <div class="pt-16 pb-5 px-4 mx-auto max-w-screen-xl">
          <div class="bg-gray-50 border border-gray-100 dark:bg-indigo-950 dark:border-0 rounded-lg shadow-lg px-5 py-8 sm:px-8 md:p-12 lg:mb-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                  ...
                  <li aria-current="page">
                    <div class="flex items-center">
                      ...
                      <span class="ml-1 text-xs md:text-sm font-medium text-gray-700 md:ml-2">List FIDS</span>
                    </div>
                  </li>
                </ol>
              </nav>
              ...
              <p class="text-sm lg:text-lg font-normal font-montserrat text-gray-500 dark:text-gray-200 mb-3">
                Tabel perangkat ini akan menampilkan data dari nama perangkat FIDS. Nama perangkat dapat diubah dan dihapus
              </p>
              ...
              <div class="pt-3 lg:flex items-center flex-row space-y-7 lg:space-x-4 lg:space-y-0">
                  {{-- add data --}}
                  <div>
                    <button type="button" data-modal-target="create-modal" data-modal-toggle="create-modal" class="px-5 py-3.5 text-xs sm:text-sm md:text-base font-medium text-center inline-flex items-center text-gray-50 bg-indigo-800 rounded-lg hover:bg-gray-100 hover:text-green-700 focus:z-10 focus:ring-2 focus:ring-indigo-800 transition duration-200 dark:bg-gray-100 dark:text-green-700 dark:hover:bg-indigo-900 dark:hover:text-gray-100 dark:border-gray-100">
              ...
              <tbody class=" font-roboto text-center text-xs md:text-sm dark:text-gray-200">
                  @foreach ($list as $data)
                      <tr>
                        ...
                        <td class="px-6 py-4">
                          <form onsubmit="return confirm('Apakah anda ingin menghapus data ini ?')" action="{{route('list.fids.destroy', $data->id)}}" method="post">
                            @csrf
                            @method('DELETE')
                            <div class="inline-flex rounded-md shadow-md" role="group">
                              <a href="{{route('list.fids.edit', $data->id)}}" class=" inline-flex items-center px-4 py-2 tetx-xs md:text-sm font-medium text-gray-50 bg-indigo-800 rounded-l-lg hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 dark:bg-gray-100 dark:text-indigo-800 dark:hover:bg-indigo-900 dark:hover:text-gray-100 transition duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 mr-2 h-5">
                              ...
                              <button type="submit" class="inline-flex items-center px-4 py-2 text-xs md:text-sm font-medium text-gray-50 bg-indigo-800 rounded-r-md hover:bg-gray-100 hover:text-red-800 focus:z-10 focus:ring-2 focus:ring-red-800 focus:bg-gray-100 focus:text-red-800 dark:bg-gray-100 dark:text-red-800 dark:hover:bg-indigo-900 dark:hover:text-gray-100 transition duration-200">
            ...
            <div class="px-6 py-6 lg:px-8 font-montserrat">
                ...
                <form class="space-y-6" action="{{route('list.fids.store')}}" method="POST">
                  @csrf
                    ...
                    <button type="submit" class="w-full text-gray-50 bg-indigo-800 rounded-lg hover:bg-gray-100 hover:text-green-700 focus:z-10 focus:ring-2 focus:ring-indigo-800 transition duration-200 text-xs md:text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-gray-100">Tambah</button>
                </form>
            </div>
        </div>
    </div>
