                ...
                <form class="space-y-4 md:space-y-6" action="{{route('list.komputer.update', $komputer_list->id)}}" method="POST">
                  ...
                  @method('PUT')
                    <div>
                        ...
                        <input type="text" name="name" id="email" class="bg-gray-50 border-2 border-gray-100 text-gray-900 text-xs md:text-sm rounded-lg block w-full p-2.5 focus:ring-indigo-400 focus:ring-2 focus:outline-none" value="{{$komputer_list->name}}">
                    </div>
