        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <a href="{{route('cctv.create')}}" class="flex ml-2 md:mr-24">
              ...
              <span class="self-center font-roboto uppercase font-semibold hidden sm:block sm:text-base md:text-lg lg:text-xl text-gray-100 whitespace-nowrap">Kontak & Saran - Ubah Data</span>
            </a>
          </div>
        ...
        <div class="py-16 px-4 mx-auto max-w-screen-xl text-start">
          <div class="bg-gray-50 border border-gray-100 dark:border-0 dark:bg-indigo-950 rounded-lg shadow-lg px-5 py-8 sm:px-8 md:p-12">
            ...
            <div class="font-roboto flex-row items-center">
              <div class="mt-4">
                <form action="{{route('kontak.admin.update', $kontak->id)}}" method="POST" enctype="multipart/form-data">
                  @csrf 
                  @method('PUT')
