      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{route('dashboard')}}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-xl font-roboto font-semibold sm:text-2xl text-gray-100 whitespace-nowrap">FIDS - Add Data</span>
          </a>
        </div>
    ...
    <section class="bg-white">
      <div class="py-16 px-4 mx-auto max-w-screen-xl text-start lg:py-16">
        <div class="bg-gray-50 border border-gray-100 rounded-lg shadow-md p-8 md:p-8 mb-8"> 
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="{{route('fids.index')}}" class="ml-1 text-sm font-medium text-gray-900 hover:text-indigo-600 md:ml-2">FIDS</a>
                </div>
              </li>
          ...
          <h1 class="text-gray-900 lg:px-2 mt-6 text-lg uppercase md:text-xl font-montserrat font-bold">
            Add Data Page
          </h1>
              ...
              <form id="{{$dataForm}}" enctype="multipart/form-data" class="">
                ...
                <div class="mb-3 lg:flex space-x-4 items-center justify-start space-y-4 lg:space-y-0">
                  ...
                  <div>
                    ...
                    <input type="text" id="record-desc" class="bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3" required name="view_desc">
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="text" id="clean-desc" class="bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3" required name="condition_desc">
                  </div>
                </div>
              
                <div class="text-center lg:text-start">
                  <div class="inline-flex rounded-md shadow-sm" role="group">
                    <button type="button" data-form="{{$dataForm}}" class="submitButton inline-flex items-center px-4 py-2 text-sm font-medium text-gray-100 bg-indigo-800 rounded-l-lg hover:bg-gray-100 hover:text-green-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 transition duration-200">
                    ...
                    <button type="reset" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-100 bg-indigo-800 hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 transition duration-200">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 mr-3 h-5">
                    ...
                    <button type="button" data-target="{{$toHide}}" class="hideButton inline-flex items-center px-4 py-2 text-sm font-medium text-gray-100 bg-indigo-800 rounded-r-md hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-2 focus:ring-indigo-800 transition duration-200">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 mr-3 h-5">
