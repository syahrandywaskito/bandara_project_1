    ...
    <div class="py-7 md:px-5 lg:ml-64">
      <div>
        <div class="pt-16 px-4 mx-auto max-w-screen-xl text-start">
          <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md px-5 py-8 sm:px-8 md:p-12">
            <!-- Breadcrumb -->
              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <a href="{{route('fids.index')}}" class="ml-1 text-xs md:text-sm font-medium hover:text-indigo-600 dark:hover:text-slate-400 md:ml-2">FIDS</a>
                  </div>
                </li>
                <li aria-current="page">
                  <div class="flex items-center">
                    ...
                    <span class="ml-1 text-xs md:text-sm font-medium md:ml-2">Add Data</span>
                  </div>
                </li>
              </ol>
            </nav>
