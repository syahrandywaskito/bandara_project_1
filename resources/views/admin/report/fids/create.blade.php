          ...
          <div class="bg-gray-50 border border-gray-100 dark:bg-indigo-950 dark:border-0 rounded-lg shadow-md px-5 py-8 sm:px-8 md:p-12">
              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <a href="{{route('fids.index')}}" class="ml-1 text-xs md:text-sm font-medium text-gray-900 hover:text-indigo-600 md:ml-2">FIDS</a>
                  </div>
                </li>
            ...
            <div class="flex space-x-4 mt-6">
              ...
              <div class="flex-initial w-60">
                <form class="flex items-center" method="get" action="{{route('fids.create')}}">
                  @csrf
              ...
              {{-- show current data --}}
              <div>
                <form action="{{route('fids.create')}}" method="GET">
            ...
            <div class="font-roboto flex-row items-center mt-10">
              ...
              <div id="{{$hideElement}}" class="mt-5">
                <form id="{{$dataForm}}" enctype="multipart/form-data" class="">
                  ...
                  {{-- button group contain submit, reset, and hide form after input or unecessary --}} {{-- button text hide in under md viewport --}}
