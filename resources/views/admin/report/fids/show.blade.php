...
<body>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{route('cctv.index')}}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-xl font-roboto font-semibold sm:text-2xl text-gray-100 whitespace-nowrap">FIDS - Show</span>
          </a>
        </div>
  ...
  @php
      $created_at = DB::table('fids')->select('created_at')->get();
      // var_dump($created_at);
  @endphp
