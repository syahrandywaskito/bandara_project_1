      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{route('dashboard')}}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-lg font-roboto font-semibold sm:text-xl text-gray-100 uppercase whitespace-nowrap">FIDS - Ubah data</span>
          </a>
        </div>
          ...
          <form class="font-montserrat lg:px-2 mt-6" action="{{route('fids.update', $fid->id)}}" method="POST">
            ...
            <div class="grid grid-cols-1 grid-flow-row-dense md:grid-cols-3 gap-4">
              <div class=" md:col-span-3">
                <label for="hardware-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Monitor Name</label>
                <input type="text" id="hardware-name" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-200 dark:bg-gray-200 w-full p-3" required value="{{$fid->monitor_name}}" readonly name="monitor_name">
              </div>
              ...
              <div>
                <label for="record-status" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Monitor View</label>
              ...
              <div class="md:col-span-2">
                <label for="record-desc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">View Description</label>
                <input type="text" id="record-desc" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-100 w-full p-3" required name="view_desc" value="{{$fid->view_desc}}">
              </div>
              <div>
                <label for="clean-status" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Clean Condition</label>
              ...
              <div class="md:col-span-2">
                <label for="clean-desc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Condition Description</label>
                <input type="text" id="clean-desc" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-100 w-full p-3" required name="condition_desc" value="{{$fid->condition_desc}}">
              </div>
            </div>
