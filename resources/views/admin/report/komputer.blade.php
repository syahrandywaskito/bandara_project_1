        ...
        <div class="pt-16 px-4 mx-auto max-w-screen-xl">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg px-5 py-8 sm:px-8 md:p-12 lg:mb-8">
              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                ...
                <li aria-current="page">
                  <div class="flex items-center">
                    ...
                    <span class="ml-1 text-xs md:text-sm font-medium md:ml-2">Komputer</span>
                  </div>
                </li>
              </ol>
            </nav>
            ...
            <div class="pt-3 lg:flex items-center flex-row space-y-7 lg:space-x-4 lg:space-y-0">
              ...
              {{-- add data --}}
              @include('components.dashboard.buttons._add-button', ['route' => route('komputer.create')])
              ...
              <tr>
                ...
                <td class="px-6 py-4">
                  <form onsubmit="return confirm('Anda yakin ingin menghapus data ini ?')" action="{{route('komputer.destroy', $data->id)}}" method="POST">
                    ...
                    @include('components.dashboard.buttons._edit-in-table', ['route' => route('komputer.edit', $data->id)])

                    @include('components.dashboard.buttons._show-in-table', ['route' => route('komputer.show', $data->id)])
