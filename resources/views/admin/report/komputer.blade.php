                    ...
                    <form action="{{route('komputer.index')}}" method="GET">
                      <div class="flex">
                          ...
                          <div class="relative w-full font-montserrat">
                              <input type="text" class="block p-3.5 w-full z-20 text-xs md:text-sm text-gray-900 bg-gray-200 border-2 border-gray-200 rounded-r-lg outline-none  focus:border-indigo-800 dark:border-gray-50 dark:bg-gray-50" placeholder="Cari" name="cari" required>
  
                              <button type="submit" class="absolute top-0 right-0 p-3 text-xs md:text-sm font-medium h-full text-gray-50 bg-indigo-800 rounded-r-lg hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 focus:outline-none dark:bg-gray-50 dark:text-indigo-900 dark:hover:bg-indigo-900 dark:hover:text-gray-100 transition duration-200 dark:hover:ring-1 dark:hover:ring-indigo-900" title="Cari data">
                  ...
                  <div class=" flex-initial w-60">
                    <form class="flex items-center" method="get" action="{{route('komputer.index')}}"> 
                      ...
                      <div class="relative w-full">
                          ...
                          <input type="date" id="date" name="selected_date" class="font-roboto z-20 text-xs md:text-sm text-gray-900 bg-gray-200 border-2 border-gray-200 rounded-lg outline-none  focus:border-indigo-800 dark:bg-gray-50 dark:border-gray-50 block w-full pl-10 p-3" required>
                        </div>
                        ...
                        <td class="px-6 py-4">
                          <form onsubmit="return confirm('Anda yakin ingin menghapus data ini ?')" action="{{route('komputer.destroy', $data->id)}}" method="POST">
                            ...
                            <div class="inline-flex rounded-md shadow-md" role="group">
                              <a href="{{route('komputer.edit', $data->id)}}" title="Edit data" class=" inline-flex items-center px-4 py-2 text-xs md:text-sm font-medium text-gray-50 bg-indigo-800 rounded-l-lg hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 dark:bg-gray-100 dark:text-indigo-800 dark:hover:bg-indigo-900 dark:hover:text-gray-100 transition duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 mr-2 h-5">
