                  ...
                  <div>
                    <form>
                      <div class="flex">
                          ...
                          <button id="dropdown-button" data-dropdown-toggle="dropdown-search" class="flex-shrink-0 z-10 inline-flex items-center py-3 px-4 text-sm font-medium font-montserrat text-center text-gray-900 bg-gray-200 border-2 border-gray-200 rounded-l-lg hover:bg-gray-100 focus:border-indigo-800 outline-none dark:border-gray-100" type="button">
                            All categories 
                          ...
                          <div class="relative w-full font-montserrat">
                              <input type="search" id="search-dropdown" class="block p-3.5 w-full z-20 text-sm text-gray-900 bg-gray-200 border-2 border-gray-200 rounded-r-lg outline-none  focus:border-indigo-800 dark:border-gray-100" placeholder="search" required>
                  ...
                  <div class=" flex-initial w-60">
                    <form class="flex items-center" method="get" action="{{route('komputer.index')}}"> 
                      ...
                      <div class="relative w-full">
                          ...
                          <input type="date" id="date" name="selected_date" class="z-20 text-sm text-gray-900 bg-gray-200 border-2 border-gray-200 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-100 block w-full pl-10 p-3" required>
                      </div>
