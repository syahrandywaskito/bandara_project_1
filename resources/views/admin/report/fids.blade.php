      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{route('fids.index')}}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center uppercase font-roboto font-semibold hidden sm:block sm:text-base md:text-lg lg:text-xl text-gray-100 whitespace-nowrap">Laporan - FIDS</span>
          </a>
        </div>
    ...
    <div class="bg-white dark:bg-slate-900">
      <div class="pt-16 pb-5 px-4 mx-auto max-w-screen-xl">
          <div class="bg-gray-50 border border-gray-100 dark:bg-indigo-950 dark:border-0 rounded-lg shadow-lg px-5 py-8 sm:px-8 md:p-12 lg:mb-8">
              ...
              <h1 class="text-gray-900 mt-8 dark:text-gray-200 text-base md:text-lg xl:text-xl uppercase font-roboto font-bold mb-4">
                  ...
                  <div class=" flex-initial w-60">
                    <form class="flex items-center" method="get" action="{{route('fids.index')}}"> 
                      ...
                      <div class="relative w-full">
                          ...
                          <input type="date" id="date" name="selected_date" class="z-20 text-xs md:text-sm text-gray-900 bg-gray-200 border-2 border-gray-200 rounded-lg outline-none  focus:border-indigo-800 dark:bg-gray-50 dark:border-gray-50 block w-full pl-10 p-3 font-roboto" required>
                      </div>
                      <button type="submit" title="Cari berdasarkan tanggal" class="p-4 ml-2 text-xs md:text-sm font-medium text-gray-50 bg-indigo-800 rounded-lg hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 focus:outline-none dark:bg-gray-100 dark:text-indigo-900 dark:hover:bg-indigo-900 dark:hover:text-gray-100 dark:hover:border-indigo-900 dark:border-gray-100 transition duration-200">
                          <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
                          </svg>
                          <span class="sr-only">Search</span>
                        ...
                        <td class="px-6 py-4">
                          <form onsubmit="return confirm('Apakah anda ingin menghapus data ini ?')" action="{{route('fids.destroy', $data->id)}}" method="POST">
                            ...
                            <div class="inline-flex rounded-md shadow-md" role="group">
                              <a href="{{route('fids.edit', $data->id)}}" title="Edit data" class="inline-flex items-center px-4 py-2 text-xs md:text-sm font-medium text-gray-50 bg-indigo-800 rounded-l-lg hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 dark:bg-gray-100 dark:text-indigo-800 dark:hover:bg-indigo-900 dark:hover:text-gray-100 transition duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 mr-2 h-5">
