      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{route('fids.index')}}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-lg uppercase font-roboto font-semibold sm:text-xl text-gray-100 whitespace-nowrap">Laporan - FIDS</span>
          </a>
        </div>
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full sm:translate-x-0 bg-indigo-800 border-r-4 border-indigo-900" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto">
        <ul class="space-y-2 font-medium font-roboto">
          ...
          <li>
            <a id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="flex items-center p-2 text-gray-100 rounded-lg hover:bg-gray-100 hover:text-gray-900 group transition duration-150" type="button">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                  ...
                  <li aria-current="page">
                    <div class="flex items-center">
                      ...
                      <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2">FIDS</span>
                    </div>
                  </li>
                </ol>
              </nav>
                    ...
                    <form>
                      <div class="flex">
                          ...
                          <div class="relative w-full font-montserrat">
                              <input type="search" id="search-dropdown" class="font-montserrat block p-3.5 w-full z-20 text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-r-lg outline-none  focus:border-indigo-800 dark:border-gray-100" placeholder="search" required>
  
                              <button type="submit" class="absolute top-0 right-0 p-3 text-sm font-medium h-full text-gray-50 bg-indigo-800 rounded-r-lg hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 transition duration-200">
                        ...
                        <td class="px-6 py-4">
                          <form onsubmit="return confirm('Apakah anda ingin menghapus data ini ?')" action="{{route('fids.destroy', $data->id)}}" method="POST">
                            ...
                            <div class="inline-flex rounded-md shadow-md" role="group">
                              <a href="{{route('fids.edit', $data->id)}}" class=" inline-flex items-center px-4 py-2 text-sm font-medium text-gray-50 bg-indigo-800 rounded-l-lg hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 transition duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 mr-2 h-5">
                              ...
                              <a href="{{route('fids.show', $data->id)}}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-50 bg-indigo-800 hover:bg-gray-100 hover:text-indigo-800 focus:z-10 focus:ring-2 focus:ring-indigo-800 transition duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 mr-2 h-5">
