        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <a href="{{URL::current()}}" class="flex ml-2 md:mr-24">
              ...
              <span class="self-center font-roboto font-semibold hidden sm:block sm:text-base md:text-lg lg:text-xl text-gray-100 whitespace-nowrap uppercase">CCTV - Ubah Data</span>
            </a>
          </div>
