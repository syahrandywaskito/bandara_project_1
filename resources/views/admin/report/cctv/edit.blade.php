          ...
          <form class="font-montserrat lg:px-2 mt-6" action="{{route('cctv.update', $cctv->id)}}" method="POST">
            ...
            <div class="grid grid-cols-1 grid-flow-row-dense md:grid-cols-3 gap-4">
              ...
              <div class=" md:col-span-3 hidden">
                ...
                <input type="text" id="hardware-name" class="text-xs md:text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-200 w-full p-3" required value="{{auth()->user()->name}}" readonly name="updated_by">
              </div>
              <div>
              ...
              <div class="md:col-span-2">
                ...
                <input type="text" id="record-desc" class="text-xs md:text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-100 w-full p-3" required name="record_desc" value="{{$cctv->record_desc}}">
              </div>
              <div>
              ...
              <div class="md:col-span-2">
                ...
                <input type="text" id="clean-desc" class="text-xs md:text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-100 w-full p-3" required name="clean_desc" value="{{$cctv->clean_desc}}">
              </div>
            </div>
