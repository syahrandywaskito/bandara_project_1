    ...
    <div class="py-7 md:px-5 lg:ml-64">
      <div>
        <div class="pt-16 px-4 mx-auto max-w-screen-xl text-start">
          <div class="bg-white dark:bg-indigo-950 rounded-lg shadow-md px-5 py-8 sm:px-8 md:p-12 md:mb-8">
            <!-- Breadcrumb -->
              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <a href="{{URL::previous()}}" class="ml-1 text-xs md:text-sm font-medium hover:text-indigo-600 md:ml-2">CCTV</a>
                  </div>
                </li>
            ...
            <form class="font-montserrat mt-6" action="{{route('cctv.update', $cctv->id)}}" method="POST">
              @csrf @method('PUT')
