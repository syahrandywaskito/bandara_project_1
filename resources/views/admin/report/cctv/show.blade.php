              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-60 lg:gap-y-10 dark:text-gray-200">
                <div>
                  <div class="font-montserrat mt-6 lg:px-2">
                    ...
                    <p class="pt-2 text-xs sm:text-sm md:text-base">
                      <span @if ($cctv->
                        record_status == 'T') class="text-gray-50 bg-black py-1 px-2 rounded-l-lg inline-block" @elseif($cctv->record_status == 'S') class="text-gray-50 bg-red-700 py-1 px-2 rounded-l-lg inline-block" @else
                ...
                <div>
                  <div class="font-montserrat mt-6 lg:px-2">
                    ...
                    <p class="pt-2 text-xs sm:text-sm md:text-base">
                      <span @if ($cctv->
                        clean_status == 'T') class="text-gray-50 bg-black py-1 px-2 rounded-l-lg inline-block" @elseif($cctv->clean_status == 'S') class="text-gray-50 bg-red-700 py-1 px-2 rounded-l-lg inline-block" @else class="text-gray-50
