          ...
          <form class="font-montserrat lg:px-2 mt-6" action="{{route('komputer.update', $komputer->id)}}" method="POST">
            ...
            <div class="grid grid-cols-1 grid-flow-row-dense md:grid-cols-3 gap-4">
              ...
              <div class="md:col-span-3">
                ...
                <input type="text" id="computer-name" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-300 dark:bg-gray-300 block w-full p-3" required value="{{$komputer->computer_name}}" readonly name="computer_name">
              </div>
