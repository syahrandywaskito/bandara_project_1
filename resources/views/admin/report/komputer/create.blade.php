          ...
          <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md px-5 py-8 sm:px-8 md:p-12">
              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <a href="{{route('komputer.index')}}" class="ml-1 text-xs md:text-sm font-medium hover:text-indigo-600 dark:hover:text-slate-400 md:ml-2">Komputer</a>
                  </div>
                </li>
            ...
            <div class="flex space-x-4 mt-6">
              ...
              <div class="flex-initial w-60">
                <form class="flex items-center" method="get" action="{{route('komputer.create')}}">
                  @csrf
              ...
              {{-- show current data --}}
              <div>
                <form action="{{route('komputer.create')}}" method="GET">
            ...
            <div class="font-roboto flex-row items-center mt-10">
              <div data-dial-init class=" sticky top-20">
                <div id="alert-3" class="flex items-center p-4 my-4 dark:text-green-50 text-green-950 rounded-lg bg-green-400 dark:bg-green-700 z-30" role="alert">
                  ...
                  <div class="ml-3 text-xs md:text-sm font-roboto alert-message"></div>
                  <button
                    type="hide"
                ...
                <form id="{{$dataForm}}" enctype="multipart/form-data" class="">
                  ...
                  <div class="grid grid-cols-1 grid-flow-row-dense md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <select id="on-off-condition" class="text-xs md:text-sm text-gray-900 bg-white shadow-md rounded-lg outline-none focus:border-indigo-800 dark:border-gray-100 dark:bg-gray-100 block w-full p-3" required name="on_off_condition">
                    ...
                    <div>
                      ...
                      <select
                        id="clean-file-status"
                        class="text-xs md:text-sm text-gray-900 bg-white shadow-md rounded-lg outline-none focus:border-indigo-800 dark:border-gray-100 dark:bg-gray-100 block w-full p-3"
                        required
                        name="clean_file_status"
                      >
                  ...
                  {{-- button group contain submit,reset, and hidden form if form unecessary --}} {{-- button text hidden if viewport under sm --}}
