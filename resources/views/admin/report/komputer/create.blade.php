      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{route('cctv.create')}}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-lg font-roboto uppercase font-semibold sm:text-xl text-gray-100 whitespace-nowrap">Komputer - Tambah Data</span>
          </a>
        </div>
          ...
          {{-- <form action="{{route('komputer.store')}}" method="POST">
            ...
            <div class="mb-3 lg:flex space-x-4 items-center justify-start space-y-4 lg:space-y-0 ">
              ...
              <div>
                ...
                <input type="text" id="computer-name" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-300 dark:bg-gray-300 block w-full p-3" required value="Komputer 1" readonly name="computer_name">
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" id="on-off-desc" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-100 w-full p-3" required name="on_off_desc">
              </div>
              <div>
                <label for="uninstalled-app" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">
                  Aplikasi di Uninstall
                </label>
                <input type="text" id="uninstalled-app" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-100 w-full p-3" required name="uninstalled_app">
              </div>
              <div>
                ...
                <input type="text" id="uninstalled-app-desc" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-100 w-full p-3" required name="uninstalled_app_desc">
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" id="clean-file-desc" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-100 w-full p-3" required name="clean_file_desc">
              </div>
            </div>
            ...
            <div class="inline-flex rounded-md shadow-sm ml-4 lg:ml-0" role="group">
              ...
              <button type="button" class="hideButton inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gray-900 border-2 border-gray-900 rounded-r-md hover:bg-gray-500 hover:border-gray-500 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:bg-indigo-900 dark:border-indigo-900 dark:hover:bg-indigo-950">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 mr-3 h-5">
              ...
              <form id="{{$dataForm}}" enctype="multipart/form-data" class="">
                ...
                <div class="grid grid-cols-1 grid-flow-row-dense md:grid-cols-3 gap-4">
                  ...
                  <div class="md:col-span-3">
                    ...
                    <input type="text" id="computer-name" class="text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none  focus:border-indigo-800 dark:border-gray-300 dark:bg-gray-300 block w-full p-3" required value="{{$item->name}}" readonly name="computer_name">
                  </div>
                ...
                <div class="inline-flex rounded-md shadow-sm ml-4 mt-3 lg:ml-0" role="group">
