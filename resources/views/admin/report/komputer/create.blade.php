              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <a href="{{route('komputer.index')}}" class="ml-1 text-xs md:text-sm font-medium text-gray-900 hover:text-indigo-600 md:ml-2">Komputer</a>
                  </div>
                </li>
                  ...
                  <div class="grid grid-cols-1 grid-flow-row-dense md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-2">
                      ...
                      <input
                        type="text"
                        id="clean-file-desc"
                        class="text-xs sm:text-sm text-gray-900 bg-gray-50 border-2 border-gray-400 rounded-lg outline-none focus:border-indigo-800 dark:border-gray-100 w-full p-3"
                        required
