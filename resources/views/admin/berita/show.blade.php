...
<html lang="en">
  ...
  <body class="bg-gradient-to-b from-indigo-200 to-indigo-700 h-full overflow-auto">

    <div class="flex justify-between items-center mt-10">
      {{-- Back Button --}}
      <div class=" max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-6 md:px-0">
        <a href="{{URL::previous()}}" class="flex items-center text-gray-900 hover:bg-indigo-900 dark:hover:text-indigo-950 dark:hover:bg-gray-100 hover:shadow-md hover:text-gray-50 rounded-lg transition duration-300 font-semibold">
    ...
    <section class="mt-12 sm:my-5">
      <div class="flex flex-col items-center justify-center px-6 py-8 mx-autolg:py-0">
        <a href="{{URL::previous()}}" class="flex items-center mb-6 text-base md:text-lg lg:text-xl font-bold font-montserrat text-gray-900 uppercase" data-aos="fade-up" data-aos-duration="200" data-aos-delay="50">
          Tampilan Berita
        </a>
        <div class="w-full bg-gray-50 dark:bg-indigo-950 bg-opacity-60 rounded-lg shadow-lg md:mt-0 sm:w-[70%] xl:p-0" data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
          <div class="p-6 space-y-4 md:space-y-8 sm:p-8 font-roboto" data-aos="fade-up" data-aos-duration="400" data-aos-delay="200">
            ...
            <div>
              <h2 class="text-center uppercase font-semibold">{{$berita->judul}}</h2>
            </div>
