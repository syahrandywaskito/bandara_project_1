...
<div class="py-7 md:px-5 lg:ml-64">
      <div>
        <div class="pt-16 px-4 mx-auto max-w-screen-xl">
          <div class="bg-white dark:bg-slate-800 dark:border-0 rounded-lg shadow-lg px-5 py-8 sm:px-8 md:p-12 lg:mb-8">
            <!-- Breadcrumb -->
            <nav class="flex py-3 text-gray-700 dark:text-gray-100 rounded-lg" aria-label="Breadcrumb">
              <ol class="inline-flex items-center space-x-1 md:space-x-3 font-montserrat">
                <li class="inline-flex items-center">
                  <a href="{{route('dashboard')}}" class="inline-flex items-center font-medium hover:text-indigo-600 text-xs md:text-sm dark:hover:text-slate-400">
            ...
            <div class="pt-3 flex-row space-y-10  font-montserrat text-gray-600 dark:text-gray-200">  
              ...
              <div>
                ...
                <a href="{{route('system.index.backup')}}" class="ml-6 bg-indigo-800 text-gray-50 p-3 rounded-lg shadow-lg hover:bg-gray-100 hover:text-indigo-800 dark:bg-slate-600 dark:hover:text-gray-100 dark:hover:bg-slate-400 transition duration-200">Backup Data</a>
                {{-- flash message --}}
                ...
                <form method="post" action="{{ route('system.index.restore') }}">
                  @csrf
                  <button type="submit" class="ml-6 bg-indigo-800 text-gray-50 p-2.5 rounded-lg shadow-lg hover:bg-gray-100 hover:text-indigo-800 dark:bg-slate-600 dark:hover:text-gray-100 dark:hover:bg-slate-400 transition duration-200">Restore Data</button>
                </form>
