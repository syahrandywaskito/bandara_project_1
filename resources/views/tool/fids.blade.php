    ...
    <nav class="bg-white shadow-lg rounded-lg mx-10 mt-7" id="navbar">
      <section class="mx-auto px-4 max-w-6xl">
        ...
        <section class="hidden pb-3" id="mobile-menu">
          <ul class="text-sm">
            <li class="active">
              <a href="{{route('homepage')}}" class="block text-gray-900 py-4 px-2 font-bold">Beranda</a>
            </li>
            <li>
        ...
        <section class="bg-white shadow-lg rounded-lg">
          <div class="py-8 px-4 mx-auto lg:py-16">
            <div class="font-montserrat p-2 md:p-12 mb-8">
              <h1 class="text-gray-900 uppercase text-sm sm:text-base md:text-lg lg:text-2xl font-bold mb-2 text-start md:text-center" data-aos="fade-up" data-aos-delay="100">Laporan Pengecekan FIDS selama satu bulan</h1>
              ...
              <form method="GET" action="{{route('report.fids.download')}}" target="_blank" data-aos="fade-up" data-aos-delay="300">
