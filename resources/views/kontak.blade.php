                ...
                <div class="md:flex flex-row justify-between items-center">
                  <div class="text-start text-xs sm:text-sm md:tex-base">
                    ...
                    <p class="flex pt-2">
                      ...
                      <a href="mailto:{{$data}}" target="_blank" class="inline-flex ">
                        ...
                        <span class="text-[#a38458] hover:border-b border-[#a38458] transition duration-150">
                          {{$data}}
                        </span>                    
                      </a>
                    @endforeach
                  ...
                  <div class="text-start md:text-end pt-3 md:pt-0 text-xs sm:text-sm md:tex-base">
                    <h5>No Telepon</h5>
                    <p class="pt-2 "> 
                      @foreach ($noTlp as $data)   
                      <a href="https://wa.me/62{{$data}}" class=" inline-flex" target="_blank">
