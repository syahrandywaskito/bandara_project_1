          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8 font-roboto" data-aos="fade-up" data-aos-duration="500" data-aos-delay="400">
            ...
            <form class="space-y-4 md:space-y-6" action="{{route('authenticate')}}" method="post">
              ...
              <div class="flex items-center justify-end">
                <a href="{{route('send-email.index')}}" class="text-xs md:text-sm font-medium text-primary-600 hover:text-indigo-500">Lupa password?</a>
              </div>
              <button
                type="submit"
              ...
              <p class="text-xs md:text-sm font-light text-gray-700">Belum memiliki akun ? <a href="{{route('register')}}" class="font-medium hover:text-indigo-500">Register</a></p>
            </form>
          </div>
        </div>
      </div>
