...
input.addEventListener('change', async (e) => {
    ...
    for (const file of files) {
        ...
        originalSizeDiv.textContent = `Ukuran Sebelum Kompresi: ${bytesToSize(file.size)}`;
        ...
        compressedSizeDiv.textContent = `Ukuran Setelah Kompresi: ${bytesToSize(compressedFile.size)}`;
